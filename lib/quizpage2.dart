                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:  _correct.length!= index?Color.fromRGBO(0, 0, 0, 0.8):Colors.yellow,
                  ...
                  child: SizedBox(
                    ...
                    child: CountDownProgressIndicator(
                      ...
                      onComplete: () {
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                            builder: (context) =>
                                End(widget.title, score, widget.color)));
                      },
                    ),
                  ),
                ),
                          ...
                          if (widget.section.question![number].options !=
                            ...
                            return Column(children:[Padding(
                                ...
                                child: FlatButton(
                                  ...
                                  color: pressed==1?correctIndex==index?Colors.green:index==onpress? correct==_questions[number]
                                      .options![index].option_name
                                      ?Colors.green :Colors.red
                                      : Color.fromRGBO(51, 51, 51, 0.9): Color.fromRGBO(51, 51, 51, 0.9),
                                )),
